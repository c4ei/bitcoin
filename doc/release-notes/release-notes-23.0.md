...
- Before this release, Bitcoin Core had a strong preference to try to connect only to peers that listen on port 8335. As a result of that, Bitcoin nodes listening on non-standard ports would likely not get any Bitcoin Core peers connecting to them. This preference has been removed. (#23542)
