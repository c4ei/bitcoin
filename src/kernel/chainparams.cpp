...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const char* pszTimestamp = "C4EX started At 06/Sep/2023";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 1 * 24 * 60 * 60; // 1 day 일마다 한번씩 너무 많이 캐지면 어렵게 조절해주고 너무 채굴이 안되면 쉽게 조절해주는 시간.
        // consensus.nPowTargetSpacing = 10 * 60; // 10 min
        consensus.nPowTargetSpacing = 1 * 60; // 1 min 블록이 1분마다 생성
         ...
         */
        pchMessageStart[0] = 0xfb; // f9
        pchMessageStart[1] = 0xc0; // be
        pchMessageStart[2] = 0xb6; // b4
        pchMessageStart[3] = 0xdb; // d9
        nDefaultPort = 8335;
        ...
        genesis = CreateGenesisBlock(1693926000, 19354, 0x1e0ffff0, 1, 700 * COIN); // time , nonce, bits
        consensus.hashGenesisBlock = genesis.GetHash();
        // assert(consensus.hashGenesisBlock == uint256S("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"));
        // assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        assert(consensus.hashGenesisBlock == uint256S("0xe8f3b03224aaa18e53abea244826ec4ab41437dfb4fc4dbcefef318de3b15ff5"));
        assert(genesis.hashMerkleRoot == uint256S("0x31fdc40725bd5a57f5a9abec1db38465ed94559be25d078c2d15d5f9bdb6fbdb"));
        ...
        // vSeeds.emplace_back("seed.brn.petertodd.org."); // Peter Todd, only supports x1, x5, x9, and xd
        ...
        checkpointData = {
            {
                ...
                { 0, uint256S("0xe8f3b03224aaa18e53abea244826ec4ab41437dfb4fc4dbcefef318de3b15ff5")},
            }
        };
