...
{
    const char* pszTimestamp = "MTM started At 26/Jul/2023";
...
public:
    CMainParams() {
        ...
        // 블록이 10 분마다 생성되어야 하고 난이도를 14일마다 한번씩 너무 많이 캐지면 어렵게 조절해주고 너무 채굴이 안되면 쉽게 조절해주는 시간이다.
        consensus.nPowTargetTimespan = 7 * 24 * 60 * 60; // 7일마다 <-- 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 5 * 60; // 5분 <-- 10분
         ...
         */
        pchMessageStart[0] = 0xfb; // 0xf9
        pchMessageStart[1] = 0xc0; // 0xbe
        pchMessageStart[2] = 0xb6; // 0xb4
        pchMessageStart[3] = 0xdb; // 0xd9
        nDefaultPort = 8335; // 8333
        nPruneAfterHeight = 100000;
        m_assumed_blockchain_size = 540;
        m_assumed_chain_state_size = 7;

        genesis = CreateGenesisBlock(1690340400, 16792, 0x1d00ffff, 1, 2000000 * COIN); // genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4c2855a6a83e3014cd79c4b09917e734ff89c643cd17add15d19df06227c0474"));
        assert(genesis.hashMerkleRoot == uint256S("0xd60d159e04d8c503e2c46fa18dc081d397e701753e81285e77820cd3919f65b9"));
        ...
        checkpointData = {
            {
                {     0, uint256S("0x57288ee8437c8bf09dcd1d6e21a7bc77e0703a7b0e70de4c659fd7b6a15193a4")},
        ...
        chainTxData = ChainTxData{
            ...
            .nTime    = 1691506800, // 1680665245,
            .nTxCount = 0, // 820876044,
            .dTxRate  = 0.00, // 3.672283614033389,
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        chainTxData = ChainTxData{
            ...
            .nTime    = 1623164400, // 1681542696,
            .nTxCount = 0, // 65345929
            .dTxRate  = 0.00, // 0.09855282814711661
        };
    }
};
