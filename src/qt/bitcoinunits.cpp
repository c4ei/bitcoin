...
{
    switch (unit) {
    case Unit::BRN: return QString("BRN");
...
{
    switch (unit) {
    case Unit::BRN: return longName(unit);
...
{
    switch (unit) {
    case Unit::BRN: return QString("Bitcoins");
...
{
    switch (unit) {
    case Unit::BRN: return 100'000'000;
