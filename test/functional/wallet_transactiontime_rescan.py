...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BRN and create transactions
        ...
        # generate some brn to create transactions and check blockcount
        ...
        # send 10 brn to user's first watch-only address
        self.log.info('Send 10 brn to user')
        ...
        # send 5 brn to our second watch-only address
        self.log.info('Send 5 brn to user')
        ...
        # send 1 brn to our third watch-only address
        self.log.info('Send 1 brn to user')
