...
class NetTest(BitcoinTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=8335)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 8335)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=8335), {"success": False})
