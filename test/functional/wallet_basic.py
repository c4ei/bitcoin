...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BRN from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 brn in block rewards plus fees, but
        ...
        # Send 10 BRN with subtract fee from amount
        ...
        # Sendmany 10 BRN with subtract fee from amount
        ...
        # Sendmany 5 BRN to two addresses with subtracting fee from both addresses
        ...
        for target, mode in product([-1, 0], ["brn/kb", "sat/b"]):
